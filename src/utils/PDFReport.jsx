    ...
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          <Text style={styles.title}>Parking Violation Report</Text>
        ...
        <View style={styles.grid}>
          ...
          <View style={styles.card}>
            ...
            <Text
              style={[styles.value, { color: getStatusColor(report.status) }]}
            >
              {report.status}
            </Text>
          </View>
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.value}>
              {report.plateNumber?.plateNumber || "N/A"}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={{ paddingLeft: 10 }}>
            {report.plateNumber?.violations?.flat().map((violation, index) => (
        ...
        {report.imagesAdmin?.length > 0 && (
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Evidence Photos</Text>
            <View style={styles.imageGrid}>
              {report.imagesAdmin.slice(0, 3).map((image, index) => (
